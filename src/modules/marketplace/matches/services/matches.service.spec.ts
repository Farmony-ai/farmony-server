...
import { MatchRequest } from '../matches/schemas/match-request.schema';
import { MatchCandidate } from '../matches/schemas/match-candidate.schema';
...
describe('MatchesService', () => {
    ...
    } as any as FirebaseStorageService;
    ...
    beforeEach(async () => {
        ...
        const module: TestingModule = await Test.createTestingModule({
            providers: [
                ...
                { provide: FirebaseStorageService, useValue: storageService },
            ],
        }).compile();
    ...
    it('returns CREATED with providers when hits exist', async () => {
        const hits = [{ _id: '507f1f77bcf86cd799439012', name: 'Prov A', phone: '123', profilePicture: 'u/p.jpg', distance_m: 321.7 }];
    ...
    it('uses idempotency and returns prior result when idempotency_key exists', async () => {
        ...
        matchCandidateModel.find.mockReturnValue(
            chain([
                {
